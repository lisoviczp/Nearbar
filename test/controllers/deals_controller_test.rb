...
class DealsControllerTest < ActionController::TestCase
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post :create, deal: { current: @deal.current, description: @deal.description, keyword: @deal.keyword, permanent: @deal.permanent }
    end
  ...
  test "should update deal" do
    patch :update, id: @deal, deal: { current: @deal.current, description: @deal.description, keyword: @deal.keyword, permanent: @deal.permanent }
    assert_redirected_to deal_path(assigns(:deal))
  end
